...
from Hardware import MotorControl, TRSensor, UltraSoundSensor, Buzzer
...
class AutoPicoGo():
    def __init__(self, forward_speed=20, turn_speed=25, is_checking_for_obstacles=True,
        ...
        self.__LineFollowService = line_follow_service if line_follow_service is not None else LineFollowService.LineFollowService(self.__IRSensor, self.__Motor, self.forward_speed)
